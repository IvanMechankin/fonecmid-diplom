...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Мещанкин И.В. Задание ____  20/05/26
	Команда = Команды.Добавить("Заполнить");
	Команда.Заголовок = "Заполнить";
	Команда.Действие  = "Заполнить";	
	КнопкаФормы = Элементы.Добавить("КнопкаЗаполнить", Тип("КнопкаФормы"), ЭтотОбъект.КоманднаяПанель);      		
...
//++ Мещанкин И.В. Задание ____  20/05/2
...
Процедура ВКМ_ВыполнитьАвтозаполнение()
	...
	Если ВидДоговора = ПредопределенноеЗначение("Перечисление.ВидыДоговоровКонтрагентов.ВКМ_АбонентскоеОбслуживание") Тогда
		...
		ОбъектДокумент.ВКМ_ВыполнитьАвтозаполнение();
